...
export default function ConstructionProjectCard({k,project}) {
	...
	return (
		...
		className="flex flex-col border-[1px] rounded-lg border-gray-700 overflow-hidden cursor-pointer group">
			<div className="w-full overflow-hidden aspect-[16/9]">
				<img src={project?.referenceImage || 'https://images.pexels.com/photos/439416/pexels-photo-439416.jpeg?cs=srgb&dl=pexels-sevenstormphotography-439416.jpg&fm=jpg'}
				alt="Loading..."
