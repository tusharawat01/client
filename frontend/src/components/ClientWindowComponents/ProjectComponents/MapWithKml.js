...
export default function MapWithKml({kml,j}) {
	// body...
	...
	return (
		<div className={`rounded-lg 'bg-gradient-to-l to-blue-500 from-blue-600 shadow-lg shadow-blue-80/10
		p-[3px] flex items-center gap-3 hover:bg-gradient-to-l to-blue-500 from-blue-600 hover:shadow-lg hover:shadow-sky-80/10 
