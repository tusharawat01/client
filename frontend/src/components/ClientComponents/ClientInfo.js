		...
		<main className="w-full flex flex-col ">
			...
			shadow-lg" > 
				...
				<div className="flex flex-col items-center flex-1">
					<h1 className="text-2xl text-white">{currentClient?.organizationName}</h1>
					<div className="grid md:grid-cols-2 grid-cols-1 mt-6 w-full md:gap-0 gap-2">
						<div className="flex flex-col items-center md:gap-5 gap-2 ">
							<div className="flex items-center gap-1">
								...
								<p className="text-md text-white" >{currentClient?.name}</p>
							</div>
							<div className="flex items-center gap-1">
						...
						<div className="flex flex-col items-center md:gap-5 gap-2 ">
							<div className="flex items-center gap-1">
								...
								<p className="text-md text-white" >{currentClient?.clientIndustry}</p>
							</div>
							<div className="flex items-center gap-1">
