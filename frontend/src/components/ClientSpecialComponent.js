    ...
    <>
      <div
        className={`fixed h-full w-full ${
          currentSelection ? "top-0" : "top-[100%]"
        } overflow-hidden 
      ...
      >
        <div className="flex flex-col bg-gray-50 border-[1px] w-[300px] border-gray-400 rounded-lg">
          <div className="w-full flex items-center justify-between gap-14 px-3 py-2 shadow-md border-b-[1px] border-gray-700">
            <span className="text-md font-semibold text-gray-900">Details</span>
            <div
              onClick={() => {
          ...
          <div className="p-2 flex flex-col gap-3">
            ...
            <div className="flex flex-col gap-1">
              ...
              <div className="px-2 py-1 rounded-lg bg-white border-[1px] border-gray-300 focus-within:border-blue-500">
                <textarea
                  type="text"
                  className="outline-none bg-transparent text-sm resize-none h-[50px] 
							placeholder:text-gray-500 text-gray-900 w-full"
          ...
          <div className="w-full flex items-center justify-end gap-2 px-3 py-2 shadow-md border-t-[1px] border-gray-400">
            ...
            <button
              onClick={() => {
                saveSelection(currentSelection, tag, issue, severity);
              }}
          ...
          <div className="flex items-center gap-2">
            <div
              ...
              className={`px-3 py-2 text-gray-100 hover:bg-gray-700  transition-all text-sm duration-200 
					ease-in-out ${
            currentTab === "details"
              ? "border-blue-500 border-b-[1.4px] pb-[6.6px]"
              : "pb-2 border-transparent"
            ...
            {(currentProject?.dataCollection?.toLowerCase() ===
              "not required" ||
      ...
      {currentTab === "analyse" ? (
        <AnalyseTab
          ...
          setOpenImageSelector={setOpenImageSelector}
        ...
        <UploadTab
          deliverablesRequested={currentProject?.deliverablesRequired}
