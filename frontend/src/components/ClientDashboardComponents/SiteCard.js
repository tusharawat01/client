...
import {fetchProjectsBySiteId} from '../../utils/ApiRoutes';
import axios from 'axios';
import {useRecoilState} from 'recoil';

export default function SiteCard({site,k}) {
	...
	const fetchProjectsBySiteIdFunc = async() => {
	...
	return (
		<div className="rounded-lg border-[1px] border-gray-300 shadow-lg hover:shadow-xl flex flex-col">
			...
			<div className="p-2 flex flex-col gap-2">
				...
				<Link href={`/clientDashboard/sites/${site?._id}`}>
					<button className="text-white text-sm w-full rounded-lg py-1 mt-1 transition-all 
